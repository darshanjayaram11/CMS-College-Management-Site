...
router.get('/submit-assignments', requireAuth, controller.submitAssignmentPage);
router.post('/submit-assignment', requireAuth,controller.submitAssignment);
  
router.get('/view-submissions', requireAuth, controller.viewSubmissions);

router.get('/timetable', requireAuth, controller.getTimeTable);

router.get('/fee', requireAuth, controller.getFees);
